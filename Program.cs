...
ArrayHelper.WriteStringArray(ArrayHelper.SelectStringsNoLongerThan(sample1), "Выходной массив:");
Console.WriteLine();

string[] sample2 = new string[] {"1234", "1567", "-2", "computer science"};
sample2.WriteStringArrayExt("Пример 2. Входной массив:");
ArrayHelper.WriteStringArray(ArrayHelper.SelectStringsNoLongerThan(sample2), "Выходной массив:");
Console.WriteLine();

string[] sample3 = new string[] { "Russia", "Denmark", "Kazan" };
sample3.WriteStringArrayExt("Пример 3. Входной массив:");
ArrayHelper.WriteStringArray(ArrayHelper.SelectStringsNoLongerThan(sample3), "Выходной массив:");
Console.WriteLine();
...
ArrayHelper.WriteStringArray(ArrayHelper.SelectStringsNoLongerThan(sample4), "Выходной массив:");
Console.WriteLine();
